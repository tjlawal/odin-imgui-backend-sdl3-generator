...
InputTextState :: struct {
	...
	EditedBefore:         bool,           // edited since activated
	EditedThisFrame:      bool,           // edited this frame
...
ViewportP :: struct {
	...
	BgFgDrawListsLastTimeActive: [2]f32,          // Last frame number the background (0) and foreground (1) draw lists were used
...
Context :: struct {
	...
	ConfigNavWindowingKeyNext:     KeyChord, // = ImGuiMod_Ctrl | ImGuiKey_Tab (or ImGuiMod_Super | ImGuiKey_Tab on OS X). Set to 0 to disable. For reconfiguration (see #4828)
	...
	InputTextReactivateId:            ID,                        // ID of InputText to reactivate on next frame (for io.ConfigInputTextEnterKeepActive behavior)
...
Table :: struct {
	...
	LastHeldHeaderColumn:       TableColumnIdx,              // Index of column header being held from previous frame.
	ReorderColumn:              TableColumnIdx,              // Index of column being reordered. (not cleared)
	ReorderColumnDstOrder:      TableColumnIdx,              // Requested display order of column being reordered.
...
foreign lib {
	...
	@(link_name="cImTextInitClassifiers")               cImTextInitClassifiers               :: proc()                                                                                                                                                                                                     ---
	@(link_name="cImTextClassifierClear")               cImTextClassifierClear               :: proc(bits: ^u32, codepoint_min: c.uint, codepoint_end: c.uint, char_class: WcharClass)                                                                                                                     ---
	@(link_name="cImTextClassifierSetCharClass")        cImTextClassifierSetCharClass        :: proc(bits: ^u32, codepoint_min: c.uint, codepoint_end: c.uint, char_class: WcharClass, _c: c.uint)                                                                                                         ---
	@(link_name="cImTextClassifierSetCharClassFromStr") cImTextClassifierSetCharClassFromStr :: proc(bits: ^u32, codepoint_min: c.uint, codepoint_end: c.uint, char_class: WcharClass, s: cstring)                                                                                                         ---
	...
	@(link_name="cImRound64")                                cImRound64                                :: proc(f: f32) -> f32                                     --- // FIXME: Positive values only.
	...
	@(link_name="ImGuiInputTextState_GetText")                        InputTextState_GetText                           :: proc(self: ^InputTextState) -> cstring                                                   ---
	// Cursor & Selection
	...
	@(link_name="ImGuiInputTextState_SetSelection")      InputTextState_SetSelection      :: proc(self: ^InputTextState, start: c.int, end: c.int) ---
	...
	@(link_name="ImGui_GetScale")                                   GetScale                                   :: proc() -> f32                                                                                         --- // FIXME-DPI: I don't want to formalize this just yet. Because reasons. Please don't use.
	...
	@(link_name="ImGui_GetMouseButtonFromPopupFlags")   GetMouseButtonFromPopupFlags   :: proc(flags: PopupFlags) -> MouseButton                                                                             ---
	@(link_name="ImGui_IsPopupOpenRequestForItem")      IsPopupOpenRequestForItem      :: proc(flags: PopupFlags, id: ID) -> bool                                                                            ---
	@(link_name="ImGui_IsPopupOpenRequestForWindow")    IsPopupOpenRequestForWindow    :: proc(flags: PopupFlags) -> bool                                                                                    ---
	// Tooltips
	...
	@(link_name="ImGui_TableFixDisplayOrder")                                TableFixDisplayOrder                                :: proc(table: ^Table)                                                                                                                  ---
	...
	@(link_name="ImGui_TableSetColumnDisplayOrder")                          TableSetColumnDisplayOrder                          :: proc(table: ^Table, column_n: c.int, dst_order: c.int)                                                                               ---
	@(link_name="ImGui_TableQueueSetColumnDisplayOrder")                     TableQueueSetColumnDisplayOrder                     :: proc(table: ^Table, column_n: c.int, dst_order: c.int)                                                                               ---
	...
	@(link_name="ImGui_RenderColorComponentMarker")           RenderColorComponentMarker           :: proc(bb: Rect, col: u32, rounding: f32)                                                                                                                             ---
	...
	@(link_name="ImGui_RenderRectFilledInRangeH")       RenderRectFilledInRangeH       :: proc(draw_list: ^DrawList, rect: Rect, col: u32, fill_x0: f32, fill_x1: f32, rounding: f32) ---
	...
	@(link_name="ImGui_ExtendHitBoxWhenNearViewportEdge") ExtendHitBoxWhenNearViewportEdge :: proc(window: ^Window, bb: ^Rect, threshold: f32, axis: Axis)                                                                     ---
	...
	@(link_name="ImGui_TempInputText")            TempInputText            :: proc(bb: Rect, id: ID, label: cstring, buf: cstring, buf_size: c.size_t, flags: InputTextFlags = {}, callback: InputTextCallback = nil, user_data: rawptr = nil) -> bool      ---
	...
	@(link_name="ImGui_GetInputTextState")        GetInputTextState        :: proc(id: ID) -> ^InputTextState                                                                                                                                               --- // Get input text state if active
	...
	@(link_name="ImGui_SetNextItemColorMarker")  SetNextItemColorMarker  :: proc(col: u32)                                        ---
	// Plot
	...
	@(link_name="ImGui_DemoMarker") DemoMarker :: proc(file: cstring, line: c.int, section: cstring) ---
	// Debug Tools
	...
	@(link_name="ImGui_DebugNodeFontGlyphsForSrcMask")          DebugNodeFontGlyphsForSrcMask                :: proc(font: ^Font, baked: ^FontBaked, src_mask: c.int)                                                                                                            ---
	...
	@(link_name="ImGui_DebugNodeInputTextState")                DebugNodeInputTextState                      :: proc(state: ^InputTextState)                                                                                                                                     ---
	...
	@(link_name="cImFontAtlasFontRebuildOutput")                cImFontAtlasFontRebuildOutput                :: proc(atlas: ^FontAtlas, font: ^Font)                                                                                                                             ---
